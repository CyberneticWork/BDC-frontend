										...
										<tr key={level.id} className={`hover:bg-blue-50 transition-colors duration-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
											...
											<td className="px-6 py-4 text-gray-700 max-w-xs">
												<div className="flex items-center justify-between">
													...
													<button onClick={() => Swal.fire({ title: 'Description', text: level.description || 'No description available', confirmButtonText: 'Close' })} className="ml-2 text-blue-600 hover:text-blue-800 flex-shrink-0">
