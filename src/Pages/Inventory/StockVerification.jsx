      ...
      <>
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900"> Stock Verification</h1>
              <div className="text-red-600 font-bold mt-1 text-md sm:text-base">Stock Verification Number : {nextStId}</div>
              <p className="text-gray-600 mt-1 text-sm sm:text-base">Manage and track your Stock Verifications</p>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
          <h3 className="text-lg sm:text-xl font-semibold mb-4">Create New Stock Verification</h3>
