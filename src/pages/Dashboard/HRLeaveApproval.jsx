    ...
    try {
      ...
      const formattedData = data.map((leave) => {
        ...
        return {
          ...
          duration: durationVal, // මෙතනට අලුත් durationVal එක දුන්නා
          timeSlotInfo: timeSlotInfo, // මෙතනට time/slot දත්තය දුන්නා
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire({
          ...
          title: "Approved!",
          html: appliedNopay > 0
            ? `<div class="text-left text-sm"><p>Leave approved. Email sent to employee.</p><p class="mt-2"><b>NoPay applied:</b> ${appliedNopay} day(s)</p></div>`
                        ...
                        filteredRequests.map((request) => (
                          <tr key={request.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              ...
                              {/* --- මෙතන තමයි Time Slot එක පෙන්නන්නේ --- */}
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                              ...
                              {/* --- මෙතන Modal එක ඇතුලෙත් Time Slot එක පෙන්නනවා --- */}
                              {request.timeSlotInfo && (
