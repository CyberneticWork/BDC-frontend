...
const AttendanceReport = () => {
  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      const exportData = allData.map((r, idx) => ({
        ...
        "Late Action": r.late_policy_action || "-",
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gradient-to-r from-slate-100 to-blue-50 border-b-2 border-slate-200">
                ...
                <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Late Day No</th>
                <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Late Action</th>
                <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Monthly Late Count</th>
                <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Approval</th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                data.map((r) => (
                  <tr key={r.id} className="hover:bg-blue-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      {r.late_policy_action ? (
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold border ${
                            r.late_policy_action === "No Deduction"
                              ? "bg-blue-100 text-blue-800 border-blue-200"
                              : r.late_policy_action === "Short Leave"
                    ...
                    <td className="px-6 py-4">
                      <select
                        ...
                        onChange={(e) =>
                          handleApprovalStatusChange(r, e.target.value)
                        }
  ...
  <thead>
    <tr className="bg-gradient-to-r from-slate-100 to-blue-50 border-b-2 border-slate-200">
      ...
      <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Late Action</th>
      <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Monthly Late Count</th>
      <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Leave Applied</th>
      <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Leave Type</th>
      <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Half Day Leave</th>
      <th className="text-left px-6 py-4 text-xs font-bold text-slate-700 uppercase tracking-wider">Leave Status</th>
        ...
        <tr key={r.id} className="hover:bg-blue-50 transition-colors">
          ...
          <td className="px-6 py-4">
            {r.leave_status ? (
              <span
                className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold border ${
                  r.leave_status === "Approved" || r.leave_status === "HR_Approved"
